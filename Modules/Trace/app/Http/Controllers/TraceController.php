...
namespace Modules\Trace\Http\Controllers;
...
use Modules\Trace\Http\Request\Trace\TraceServerRequest;
...
//          start trace
    ...
    private function commandHelperStartServer (string $username, string $password, Server $server, array $moduleName = null)
    {
        ...
        $tsharkControllPath  = base_path('Modules/Trace/app/Service/Bash/tshark-control.sh');
        $setShPath           = base_path('Modules/Trace/app/Service/Bash/set.sh');
