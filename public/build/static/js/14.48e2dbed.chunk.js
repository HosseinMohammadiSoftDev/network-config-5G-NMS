  ...
  [14],
  {
            ...
            function (e, a, n) {
              ...
              var l = function (e) {
                var t = e.pageClassName,
                  ...
                  d = e.href,
                  b = e.extraAriaContext,
                  p = e.ariaLabel || "Page " + n + (b ? " " + b : ""),
                  m = null;
                return (
                  r &&
                    ((m = "page"),
              ...
              var k = (function (e) {
                ...
                function i(e) {
                  ...
                  return (
                    ...
                    x(O(t), "handleNextPage", function (e) {
                      var a = t.state.selected,
                        n = t.props.pageCount;
                      e.preventDefault
                        ? e.preventDefault()
                    ...
                    x(O(t), "handlePageSelected", function (e, a) {
                      a.preventDefault
                        ? a.preventDefault()
                        : (a.returnValue = !1),
                        t.state.selected !== e &&
                    ...
                    x(O(t), "getEventListener", function (e) {
                      return x({}, t.props.eventListener, e);
                    }),
                    x(O(t), "handleBreakClick", function (e, a) {
                      a.preventDefault
                        ? a.preventDefault()
                        : (a.returnValue = !1);
                      ...
                      if (r <= n)
                        ...
                        for (b = 0; b < r; b++)
                          ...
                          (b >= u - v && b <= u + f)
                            ...
                            : s &&
                              e[e.length - 1] !== j &&
                              ((j = c.a.createElement(p, {
                                key: b,
                                breakLabel: s,
                                breakClassName: o,
                                breakLinkClassName: l,
                                breakHandler: t.handleBreakClick.bind(null, b),
    ...
    497: function (e, t, a) {
      ...
      var n = a(21),
        r = a(138),
        c = a(96),
        i = a.p + "static/media/button_loading.bbd49f26.svg",
        s = a(11),
        o = ["loading", "children"];
      t.a = function (e) {
        var t = e.loading,
          ...
          Object(n.a)(
            ...
            {},
            {
              children: [
                t ? null : a,
                t
                  ? Object(s.jsx)("img", { width: 14, src: i, alt: "loading" })
                  : null,
              ],
            }
          )
          ...
          if (
            ...
            if (e.Value) {
              var l = Math.floor(e.Value / 3600),
                ...
                p = String(u).padStart(2, "0"),
                m = String(d).padStart(2, "0");
              return "".concat(b, ":").concat(p, ":").concat(m);
            }
            if (e.remaining) {
              var j = Math.floor(e.remaining / 3600),
                v = Math.floor((e.remaining % 3600) / 60),
                f = e.remaining % 60,
                h = String(j).padStart(2, "0"),
                g = String(v).padStart(2, "0"),
                O = String(f).padStart(2, "0");
              return "".concat(h, ":").concat(g, ":").concat(O);
            }
          }
        };
    },
      ...
      var n = [
        ...
        u = function (e) {
          var t =
            ...
            c = "",
            i = "";
          if ((v(e) && ((e = e.replace("%", "")), (a = "%")), "" == (e = f(e))))
            return "";
          if ((j(e) && (n = "-"), (e = e.replace("-", "")), h(e))) {
            var s = e.indexOf(".");
            (r = e.substr(s + 1, e.length)), (e = e.substr(0, s));
          }
          return (
            (c = d(e, t)),
            (o = c.split(t)),
            r
              ? ((i = d(r, t)), (l = i.split(t)), n + c + "." + i + a)
              : n + c + a
          );
        },
        d = function (e) {
        ...
        convert: function (e) {
          ...
          if (
            ...
            (a = e.substr(d + 1, e.length)),
              (e = e.substr(0, d)),
              1 === (i = parseInt(a).toString()).length && "0" != i
                ? ((r += n[i] + " "), (r += s[a.length - 1]))
                : ((r = b(l)), (r += " " + s[a.length - 1]));
          }
          return 1 === e.length
            ? r
              ? "0" == e
      ...
      t.a = function () {
        var e = Object(b.f)(),
          ...
          j = Object(s.useState)({
            ...
            addBalance: !1,
            removeBalance: !1,
            getAccountUsageHourly: !1,
            getAccountUsageDaily: !1,
            updateBalance: !1,
            topupBalance: !1,
            debitBalance: !1,
          }),
          ...
          h = f[0],
          g = f[1],
          O = Object(s.useState)({ current: 1, total: 1, per_page: 10 }),
          y = Object(i.a)(O, 2),
          x = y[0],
          k = y[1],
          C = Object(s.useState)({ imsi: "", msisdn: "", permanent: null }),
          N = Object(i.a)(C, 2),
          B = N[0],
          S = N[1],
          P = Object(s.useState)([]),
          ...
          I = M[0],
          T = M[1],
          D = Object(s.useState)({ categories: [], data: [] }),
          q = Object(i.a)(D, 2),
          R = q[0],
          E = q[1],
          ...
          U = Y[0],
          K = Y[1],
          W = Object(p.d)(function (e) {
            return e.accounts.viewAccountData;
          }),
          J = (function () {
            var e = Object(c.a)(
              Object(n.a)().mark(function e(t, c) {
                var i, s, o, l, u;
                        ...
                        case 0:
                          return (
                            ...
                            void 0 === s
                              ...
                              : s.length) > 0 &&
                              (o.msisdn =
                                null === c || void 0 === c ? void 0 : c.msisdn),
                            null !== c &&
                              void 0 !== c &&
                              c.permanent &&
                              (o.permanent =
          ...
          Z = Object(l.a)({
            initialValues: { imsi: "", msisdn: "", permanent: !1 },
            validationSchema: u.a,
            onSubmit: function (e) {
              X(e);
            },
          }),
                        ...
                        case 5:
                          (s = t.sent),
                            ...
                            200 == s.status || 201 == s.status
                              ? (d.b.success("Account created successfully"),
                                e("/accounts/all"))
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.next = 4),
                            a.delete("/v1/accounts/".concat(c))
                          );
                        case 4:
                          200 === (i = e.sent).status || 201 == i.status
                            ? (g(
                                Object(r.a)(
                                  Object(r.a)({}, h),
                                  {},
                              ...
                              d.b.success("Account deleted successfully."),
                              t(Object(m.d)(null)),
                              t(Object(m.h)(null)),
                              k(
                                Object(r.a)(
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (c = { current_status: t.Permanent }),
                            1 == t.Permanent
                              ? (c.default_balance_id =
                                  null === (i = t.Balances) || void 0 === i
                                    ? void 0
                                    : i.find(function (e) {
                                        return (
                                          "permanent_default_monetary" ==
                                          e.balance_name
                                        );
                                      }).id)
                              : (c.default_balance_id =
                                  null === (s = t.Balances) || void 0 === s
                                    ? void 0
                                    : s.find(function (e) {
                                        return (
                                          "credit_default_monetary" ==
                                          e.balance_name
                                        );
                                      }).id),
                            (e.prev = 2),
                            ...
                            (e.next = 6),
                            a.patch("/v1/accounts/toggle/".concat(t.IMSI), c)
                          );
                        case 6:
                          (o = e.sent),
                            g(
                        ...
                        case 5:
                          (c = e.sent),
                            ...
                            c.data.data
                              ? (c.data.data
                                  .filter(function (e) {
                                    return "monetary" !== e.Type;
                                  })
                                  .map(function (e) {
                                    t.push({ label: e.Name, value: e.Name });
                                  }),
                                T(t))
                              : T([]),
                            (e.next = 15);
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          d.b.error("Please select a balance."), (e.next = 18);
                          break;
                        case 4:
                          return (
                            (e.prev = 4),
                            ...
                            (e.next = 8),
                            a.post("/v1/accountbalances/".concat(W.IMSI), {
                              balance_name:
                                null === H || void 0 === H ? void 0 : H.value,
                            })
                          );
                        case 8:
                          (c = e.sent),
                            ...
                            (200 != c.status && 201 != c.status) ||
                              (ee(null === W || void 0 === W ? void 0 : W.IMSI),
                              d.b.success("Balance added successfully."),
                              t(Object(m.b)(null))),
                            (e.next = 18);
                          break;
                        case 13:
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          (c = e.sent),
                            ...
                            200 == c.status || 201 == c.status
                              ? (t(Object(m.g)(null)),
                                d.b.success("Balance removed successfully."),
                                ee(
                                  null === W || void 0 === W ? void 0 : W.IMSI
                                ))
                              : d.b.error(c.data.data),
                            (e.next = 14);
                          break;
                        case 9:
                          (e.prev = 9),
          ...
          re = (function () {
            var e = Object(c.a)(
              Object(n.a)().mark(function e(t, c, i) {
                var s, o, l, u, d, b;
                return Object(n.a)().wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                          ...
                          return (
                            ...
                            g(
                              Object(r.a)(
                                Object(r.a)({}, h),
                                {},
                                { getAccountUsageHourly: !0 }
                              )
                            ),
                            (e.next = 9),
                            a.post("/v1/cdrs/hourly?start_time=".concat(o), {
                              imsi: i,
                              category: l,
                            })
                          );
                        case 9:
                          (b = e.sent),
                            ...
                            b.data.data &&
                              (b.data.data.map(function (e) {
                                u.push(e.hour), d.push(e.total_usage);
                              }),
                              E({ categories: u, data: d })),
                            (e.next = 19);
                          break;
                        case 14:
                          (e.prev = 14),
                      ...
                      switch ((e.prev = e.next)) {
                          ...
                          return (
                            ...
                            g(
                              Object(r.a)(
                                Object(r.a)({}, h),
                                {},
                                { getAccountUsageDaily: !0 }
                              )
                            ),
                            (e.next = 9),
                            a.post("/v1/cdrs/daily?start_time=".concat(o), {
                              imsi: i,
                              category: l,
                            })
                          );
                        case 9:
                          (b = e.sent),
                            ...
                            b.data.data &&
                              (b.data.data.map(function (e) {
                                u.push(e.day), d.push(e.total_usage);
                              }),
                              E({ categories: u, data: d })),
                            (e.next = 19);
                          break;
          ...
          ie = (function () {
            var e = Object(c.a)(
              Object(n.a)().mark(function e(c, i) {
                var s, o, l, u;
                return Object(n.a)().wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            ((s = { account_balance_id: i.id }),
                            "data" == i.type &&
                              ("GB" == c.unit.value &&
                                (s.amount = 1024 * c.value * 1024 * 1024),
                              "MB" == c.unit.value &&
                                (s.amount = 1024 * c.value * 1024),
                              "KB" == c.unit.value &&
                                (s.amount = 1024 * c.value)),
                            (o = c.hours),
                            (l = c.minutes),
                            ("voice" != i.type && "video" != i.type) ||
                              (0 === c.hours.length && (o = 0),
                              0 === c.minutes.length && (l = 0),
                              0 == parseFloat(o) && 0 == parseFloat(l)
                                ? d.b.error("Please enter hours or minutes")
                                : parseFloat(l) > 59
                                ? d.b.error("Minutes can't be more than 59")
                                : (s.amount = 60 * o * 60 + 60 * l)),
                            "monetary" == i.type &&
                              (0 === c.length
                                ? d.b.error("Please enter amount")
                                : (s.amount = parseFloat(c))),
                            !s.amount && 0 != s.amount)
                          ) {
                            e.next = 21;
                            break;
                          ...
                          return (
                            ...
                            (e.next = 11),
                            a.patch("/v1/accountbalances/update", s)
                          );
                        case 11:
                          (u = e.sent),
                            g(
                            ...
                            (200 != u.status && 201 != u.status) ||
                              (d.b.success(
                                "Balance value updated successfully."
                              ),
                              t(Object(m.j)(null)),
                              ee(null === W || void 0 === W ? void 0 : W.IMSI)),
                            (e.next = 21);
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (
                            ...
                            (e.next = 11),
                            a.patch("/v1/accountbalances/topup", s)
                          );
                        case 11:
                          (u = e.sent),
                            g(
                            ...
                            (200 != u.status && 201 != u.status) ||
                              (d.b.success("Balance topuped successfully."),
                              t(Object(m.i)(null)),
                              ee(null === W || void 0 === W ? void 0 : W.IMSI)),
                            (e.next = 21);
                          break;
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (
                            ...
                            (e.next = 11),
                            a.patch("/v1/accountbalances/debit", s)
                          );
                        case 11:
                          (u = e.sent),
                            g(
                            ...
                            (200 != u.status && 201 != u.status) ||
                              (d.b.success("Balance debited successfully."),
                              t(Object(m.c)(null)),
                              ee(null === W || void 0 === W ? void 0 : W.IMSI)),
                            (e.next = 21);
                          break;
        ...
        return {
          ...
          deleteAccount: Q,
          accountList: w,
          createAccountController: Z,
          patchAccount: $,
          filters: B,
          setFilters: S,
          accountPaginates: x,
          setAccountPaginates: k,
          accountLoadings: h,
          getBalances: te,
          balanceList: I,
          selectedBalance: H,
          setSelectedBalance: V,
          addBalance: ae,
          selectedAccountBalance: U,
          setSelectedAccountBalance: K,
          removeBalance: ne,
          getAccountUsageHourly: re,
          getAccountUsageDaily: ce,
          accountUsageData: R,
          updateBalance: ie,
          topupBalance: se,
          debitBalance: oe,
    ...
    887: function (e, t, a) {
      ...
      var j = a(515),
        ...
        g = function (e) {
          var t = e.row,
            a = Object(u.c)(),
            n = Object(f.f)(),
            r = Object(v.a)().getAccountById;
          return Object(h.jsxs)(c.Fragment, {
            children: [
              Object(h.jsx)(l.i, {
                onClick: function () {
                  a(Object(d.d)(1)), a(Object(d.h)(t));
                },
                size: "sm",
                color: "danger",
                style: { marginRight: 5 },
                children: Object(h.jsx)(b.b, { fontSize: 18 }),
              }),
              Object(h.jsx)(l.i, {
                onClick: function () {
                  r(t.IMSI), a(Object(d.e)(1)), a(Object(d.f)(t.IMSI));
                },
                size: "sm",
                color: "primary",
                style: { marginRight: 5 },
                children: Object(h.jsx)(m, { fontSize: 18 }),
              }),
              Object(h.jsx)(l.i, {
                onClick: function () {
                  n("/accounts/usage?account_IMSI=".concat(t.IMSI));
                },
                size: "sm",
                color: "warning",
                children: Object(h.jsx)(j.b, { fontSize: 18 }),
              }),
            ],
          });
        },
        O = [
          ...
          },
          {
            ...
            cell: function (e) {
              return 1 == e.Permanent
                ? Object(h.jsx)(l.f, {
                    color: "success",
                    children: "Permanent",
                  })
                : Object(h.jsx)(l.f, { color: "danger", children: "Credit" });
            },
          },
          {
            name: "",
      ...
      t.default = function () {
        var e,
          ...
          C = p.filters,
          S = p.setFilters,
          A = p.accountPaginates,
          D = p.setAccountPaginates,
          q = p.accountLoadings,
          R = p.getBalances,
          E = p.balanceList,
          F = p.selectedBalance,
          z = p.setSelectedBalance,
          H = p.addBalance,
          V = p.selectedAccountBalance,
          G = p.setSelectedAccountBalance,
          Y = p.removeBalance,
          U = p.updateBalance,
          K = p.topupBalance,
          W = p.debitBalance,
          J = Object(c.useState)({
            unit: { label: "GB", value: "GB" },
            value: "",
          }),
          Z = Object(r.a)(J, 2),
          X = Z[0],
          Q = Z[1],
          $ = Object(c.useState)({ hours: 0, minutes: 0 }),
          ee = Object(r.a)($, 2),
          te = ee[0],
          ae = ee[1],
          ...
          le = oe[0],
          ue = oe[1],
          de = Object(u.d)(function (e) {
            return e.accounts.infoModal;
          }),
          be = Object(u.d)(function (e) {
            return e.accounts.refreshAccountIMSI;
          }),
          pe = Object(u.d)(function (e) {
            return e.accounts.deleteModal;
          }),
          me = Object(u.d)(function (e) {
            return e.accounts.selectedAccount;
          }),
          je = Object(u.d)(function (e) {
            return e.accounts.viewAccountData;
          }),
          ve = Object(u.d)(function (e) {
            return e.accounts.addBalanceModal;
          }),
          fe = Object(u.d)(function (e) {
            return e.accounts.removeBalanceModal;
          }),
          he = Object(u.d)(function (e) {
            return e.accounts.updateBalanceModal;
          }),
          ge = Object(u.d)(function (e) {
            return e.accounts.topupModal;
          }),
          Oe = Object(u.d)(function (e) {
            return e.accounts.debitModal;
          });
        return (
          Object(c.useEffect)(function () {
            D(Object(n.a)(Object(n.a)({}, A), {}, { current: 1 })), m(1, C);
          }, []),
          Object(c.useEffect)(
            function () {
              de
          ...
          Object(h.jsxs)(c.Fragment, {
            children: [
              Object(h.jsx)(i.a, {
                title: "Accounts List",
                data: [{ title: "Accounts" }, { title: "Accounts List" }],
              }),
              Object(h.jsx)(l.j, {
                children: Object(h.jsx)(l.E, {
                  children: Object(h.jsxs)(l.d, {
                    children: [
                      Object(h.jsx)(l.c, {
                        targetId: "1",
                        children: "Filters",
              ...
              Object(h.jsxs)("div", {
                ...
                children: [
                  Object(h.jsx)(x.a, {
                    noDataComponent: q.getAccounts
                      ? ""
                      : Object(h.jsx)("div", {
                          style: { margin: "24px 0" },
                          children: "No Account Founded!",
                        }),
                    noHeader: !0,
                    pagination: !0,
                    columns: O,
                    paginationPerPage: A.per_page,
                    className: "react-dataTable",
                    sortIcon: Object(h.jsx)(o.a, { size: 10 }),
                    paginationComponent: function () {
                      return Object(h.jsx)(N.a, {
                        previousLabel: "",
                        nextLabel: "",
                        forcePage: A.current - 1,
              ...
              Object(h.jsx)(B.a, {
                ...
                noAction: function () {
                  return b(Object(d.d)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.deleteAccount,
                yesAction: function () {
                  f(me.IMSI);
                },
                yesColor: "danger",
              ...
              Object(h.jsx)(B.a, {
                ...
                noAction: function () {
                  return b(Object(d.b)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.addBalance,
                yesAction: function () {
                  H();
                },
                yesColor: "primary",
                ...
                type: "global",
                size: "md",
                children: Object(h.jsxs)(l.o, {
                  xs: "12",
                  children: [
                    Object(h.jsx)(l.v, { for: "balance", children: "balance" }),
                    Object(h.jsx)(_.a, {
                      isClearable: !1,
                      theme: w.m,
                      closeMenuOnSelect: !0,
              ...
              Object(h.jsx)(B.a, {
                visible: fe,
                setVisible: d.g,
                title: "Are you sure you want to remove this balance?",
                noAction: function () {
                  return b(Object(d.g)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.removeBalance,
                yesAction: function () {
                  Y();
                },
                yesColor: "danger",
              ...
              Object(h.jsxs)(B.a, {
                ...
                noAction: function () {
                  return b(Object(d.j)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.updateBalance,
                yesAction: function () {
                  "data" == V.type && 0 === X.value.length
                    ? T.b.error("Please enter data value.")
                    : "data" == V.type
                    ? U(X, V)
                    : "video" == V.type || "voice" == V.type
                    ? U(te, V)
                    : "monetary" == V.type && U(ce, V);
                },
                yesColor: "warning",
                yesTitle: "Update",
                type: "global",
                size: "md",
                children: [
                  "data" === (null === V || void 0 === V ? void 0 : V.type)
                    ? Object(h.jsxs)(l.D, {
                        children: [
                          Object(h.jsxs)(l.o, {
                            xs: "12",
                          ...
                          Object(h.jsxs)(l.o, {
                            ...
                            sm: "6",
                            children: [
                              Object(h.jsx)(l.v, { children: "value" }),
                              Object(h.jsx)(l.u, {
                                type: "number",
                                value: X.value,
                                onChange: function (e) {
                    ...
                    : null,
                  "video" === (null === V || void 0 === V ? void 0 : V.type) ||
                  "voice" === (null === V || void 0 === V ? void 0 : V.type)
                    ? Object(h.jsxs)(l.D, {
                        children: [
                          Object(h.jsxs)(l.o, {
                            xs: "12",
                    ...
                    : null,
                  "monetary" === (null === V || void 0 === V ? void 0 : V.type)
                    ? Object(h.jsx)(l.D, {
                        children: Object(h.jsxs)(l.o, {
                          xs: "12",
                          children: [
              ...
              Object(h.jsxs)(B.a, {
                ...
                title: "Topup balance",
                noAction: function () {
                  return b(Object(d.i)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.topupBalance,
                yesAction: function () {
                  "data" == V.type && 0 === X.value.length
                    ? T.b.error("Please enter data value.")
                    : "data" == V.type
              ...
              Object(h.jsxs)(B.a, {
                ...
                title: "Debit balance",
                noAction: function () {
                  return b(Object(d.c)(null));
                },
                noColor: "secondary",
                noTitle: "Cancel",
                yesLoading: q.debitBalance,
                yesAction: function () {
                  "data" == V.type && 0 === X.value.length
                    ? T.b.error("Please enter data value.")
                    : "data" == V.type
                ...
                children: Object(h.jsxs)(l.D, {
                  children: [
                    Object(h.jsx)(l.o, {
                      ...
                      md: "4",
                      className: "mb-2",
                      children: Object(h.jsxs)(l.v, {
                        style: { fontSize: 16 },
                        children: [
                          "IMSI : ",
                          null === je || void 0 === je ? void 0 : je.IMSI,
                        ],
                      }),
                    }),
                    Object(h.jsx)(l.o, {
                      ...
                      children: Object(h.jsxs)(l.v, {
                        ...
                        children: [
                          "MSISDN : ",
                          null === je || void 0 === je ? void 0 : je.MSISDN,
                        ],
                      }),
                    }),
                    Object(h.jsx)(l.o, {
                    ...
                    Object(h.jsxs)(l.o, {
                      ...
                      children: [
                        Object(h.jsx)("h5", { children: "Balances" }),
                        Object(h.jsx)(l.i, {
                          onClick: function () {
                            return b(Object(d.b)(1));
                          },
                          size: "md",
                          color: "primary",
                          children: "Add New Balance",
                        }),
                      ],
                    }),
                    null === je ||
                      ...
                      : e.map(function (e, t) {
                          return Object(h.jsx)(l.o, {
                            ...
                            children: Object(h.jsxs)(
                              ...
                              {
                                className:
                                  "w-100 p-1 m-0 border rounded-2 d-flex align-items-center pb-3",
                                style: { position: "relative" },
                                id: "balance_type_card",
                                children: [
                                  Object(h.jsx)("div", {
                                    style: {
                                      position: "absolute",
                                    ...
                                    className: "text-white rounded-2 bg-dark",
                                      ...
                                      Object(h.jsx)(l.i, {
                                        onClick: function () {
                                          if (
                                            ...
                                            ae({
                                              hours: String(t).padStart(2, "0"),
                                              minutes: String(a).padStart(
                                                2,
                                                "0"
                                              ),
                                            });
...
//# sourceMappingURL=14.48e2dbed.chunk.js.map
