import{T as w,u as f}from"./useApi-DpraN937.js";import{s as O}from"./auth-CIdfLHBs.js";function z(){for(let e=1;e<=2;e++)document.querySelector(".subMenu"+e).classList.remove("clickSubMenu")}function F(){for(let e=1;e<=4;e++)document.querySelector(".menus"+e).classList.remove("activeMenu")}document.querySelector("#v-servers-tab").addEventListener("shown.bs.tab",function(){const e=this.dataset.id;U(e)});document.querySelector("#v-userManagement").addEventListener("shown.bs.tab",function(){const e=this.dataset.id;U(e)});document.querySelector("#V-monitoring").addEventListener("shown.bs.tab",function(){const e=this.dataset.id;U(e)});function U(e){F(),z(),D(),document.querySelector(".menus"+e).classList.add("activeMenu")}function D(){for(let e=1;e<=2;e++)document.querySelector(".iconSubMenu"+e).style.display="none"}document.querySelector("#v-access-levels-tab").addEventListener("shown.bs.tab",function(){const e=this.dataset.id;$(e)});document.querySelector("#v-users-tab").addEventListener("shown.bs.tab",function(){const e=this.dataset.id;$(e)});function $(e){F(),z(),D(),document.querySelector(".menus2").classList.add("activeMenu"),document.querySelector(".subMenu"+e).classList.add("clickSubMenu"),document.querySelector(".iconSubMenu"+e).style.display="flex"}let x=!1,W=document.getElementById("showPasswordAddUser");W.addEventListener("click",function(){Z()});function Z(){x?(document.getElementById("passwordAddUser").type="password",document.getElementById("repeatPasswordAddUser").type="password",x=!1):(document.getElementById("passwordAddUser").type="text",document.getElementById("repeatPasswordAddUser").type="text",x=!0)}let T=!1,G=document.getElementById("showPasswordEditUser");G.addEventListener("click",function(){K()});function K(){T?(document.getElementById("passwordEditUser").type="password",document.getElementById("repeatPasswordEditUser").type="password",T=!1):(document.getElementById("passwordEditUser").type="text",document.getElementById("repeatPasswordEditUser").type="text",T=!0)}let H=!1,Q=document.getElementById("showPasswordShowConfig");Q.addEventListener("click",function(){X()});function X(){H?(document.getElementById("passwordShowConfig").type="password",H=!1):(document.getElementById("passwordShowConfig").type="text",H=!0)}let Y=document.getElementById("addUserModal");Y.addEventListener("click",function(){q()});let ee=document.getElementById("addTableUsers");ee.addEventListener("click",function(){let e=document.getElementById("nameInputAddUser").value,t=document.getElementById("familyInputAddUser").value,a=document.getElementById("authNameInputAddUser").value,n=document.getElementById("passwordAddUser").value,s=document.getElementById("repeatPasswordAddUser").value;e.length<3?w({text:"نام کمتر از 3 کاراکتر می باشد."}).showToast():t.length<3?w({text:"نام خانوادگی کمتر از 3 کاراکتر می باشد."}).showToast():a.length<3?w({text:"نام کاربری کمتر از 3 کاراکتر می باشد."}).showToast():n.length<8?w({text:"رمز عبور کمتر از 8 کاراکتر می باشد."}).showToast():n!=s&&w({text:"رمز عبور با فیلد تکرار مطابقت ندارد."}).showToast(),e.length>=3&&t.length>=3&&a.length>=3&&n.length>=8&&s.length>=8&&n===s&&(ae(),document.getElementById("idLoading").style.display="flex",document.getElementById("idLoading").style.background="hsla(0, 0%, 100%, 0.5)")});let te=document.getElementById("canselAddTableUser");te.addEventListener("click",function(){q()});function q(){document.getElementById("nameInputAddUser").value="",document.getElementById("familyInputAddUser").value="",document.getElementById("authNameInputAddUser").value="",document.getElementById("passwordAddUser").value="",document.getElementById("repeatPasswordAddUser").value=""}async function ae(){let e=document.getElementById("nameInputAddUser").value,t=document.getElementById("familyInputAddUser").value,a=document.getElementById("authNameInputAddUser").value,n=document.getElementById("selectAddUser").value,s=document.getElementById("passwordAddUser").value,i=document.getElementById("repeatPasswordAddUser").value;await f({method:"post",url:"add-member",data:{first_name:e,last_name:t,auth_name:a,role:n,password:s,password_confirmation:i},callback:function(d){let r=document.createElement("tr");r.setAttribute("id",`tr${d.data.user.id}`),v.push({id:d.data.user.id,name:d.data.user.first_name,family:d.data.user.last_name,authName:d.data.user.auth_name,role:d.data.role});for(let l=1;l<=6;l++){let o=document.createElement("td");if(o.setAttribute("class",`td${l}`),l==1)o.innerHTML=document.getElementById("nameInputAddUser").value;else if(l==2)o.innerHTML=document.getElementById("familyInputAddUser").value;else if(l==3)o.innerHTML=document.getElementById("authNameInputAddUser").value;else if(l==4){let c=document.createElement("span");c.innerHTML=document.getElementById("selectAddUser").value,o.appendChild(c),d.data.role=="expert"?c.setAttribute("class","badge text-bg-primary fs-5"):d.data.role=="visitor"&&c.setAttribute("class","badge text-bg-success fs-5")}else if(l==5){let c=`<svg
        ...
        >
          ...
          />
        </svg>`;o.insertAdjacentHTML("afterbegin",c)}else if(l==6){let c=`<svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="26"
          fill="currentColor"
